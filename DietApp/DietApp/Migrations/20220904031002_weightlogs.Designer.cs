...
namespace DietApp.Migrations
{
    ...
    [Migration("20220904031002_weightlogs")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DietApp.Models.WeightLogEntry", b =>
                {
                    b.Property<int>("WeightLogEntryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<float>("WeightRecordedInLbs")
                        .HasColumnType("REAL");

                    b.HasKey("WeightLogEntryId");
                    ...
                    b.HasData(
                        ...
                        {
                            WeightLogEntryId = 1,
                            DateRecorded = new DateOnly(2022, 3, 22),
                            User = 0,
                            UserId = 1,
                            WeightRecordedInLbs = 160f
                        },
                        new
                        {
                            WeightLogEntryId = 2,
                            DateRecorded = new DateOnly(2022, 3, 23),
                            User = 0,
                            UserId = 1,
            ...
            modelBuilder.Entity("DietApp.Models.WeightLogEntry", b =>
                {
                    b.HasOne("DietApp.Models.User", null)
                        .WithMany("WeightLog")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
